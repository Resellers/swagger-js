...
"use strict";var _={isPlainObject:require("lodash-compat/lang/isPlainObject"),indexOf:require("lodash-compat/array/indexOf")};module.exports.__bind=function(e,o){return function(){return e.apply(o,arguments)}};var log=module.exports.log=function(){console&&console.log(Array.prototype.slice.call(arguments)[0])};module.exports.fail=function(e){log(e)},module.exports.optionHtml=function(e,o){return'<tr><td class="optionName">'+e+":</td><td>"+o+"</td></tr>"};var resolveSchema=module.exports.resolveSchema=function(e){return _.isPlainObject(e.schema)&&(e=resolveSchema(e.schema)),e};module.exports.simpleRef=function(e){return void 0===e?null:0===e.indexOf("#/definitions/")?e.substring("#/definitions/".length):e},module.exports.extractExtensions=function(e,o,n){e&&o&&"string"==typeof e&&0===e.indexOf("x-")&&(o.vendorExtensions=o.vendorExtensions||{},o.vendorExtensions[e]=n||o[e])};


},{"lodash-compat/array/indexOf":49,"lodash-compat/lang/isPlainObject":145}],5:[function(require,module,exports){
(function (Buffer){
